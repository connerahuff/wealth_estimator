...
class Salary(IncomeType):
    ...
    def set_aside_pretax_income(self):
        if (self.yearly_income * (self.retire_pct/100) > self.yearly_income):
            ...
            return 0
        elif (self.yearly_income * (self.retire_pct/100) > 19000):
            return 19000
        else:
    ...
    def set_aside_espp_amt(self):
        espp_amt = 0
        if ((self.net_income) * (self.espp_pct/100) >= 16500):
            espp_amt = 16500
        else:
    ...
    def tax_salary(self):
        ...
        if (post_retire_income >= 10000000):
            effective_tax_rate = 52.07
        elif (post_retire_income >= 5000000):
            effective_tax_rate = 51.49
        elif (post_retire_income >= 2000000):
            effective_tax_rate = 49.75
        elif (post_retire_income >= 1000000):
            effective_tax_rate = 46.86
        elif (post_retire_income >= 800000):
            effective_tax_rate = 45.66
        elif (post_retire_income >= 500000):
            effective_tax_rate = 42.27
        elif (post_retire_income >= 400000):
            effective_tax_rate = 40.68
        elif (post_retire_income >= 300000):
            effective_tax_rate = 38.18
        elif (post_retire_income >= 250000):
            effective_tax_rate = 36.45
        elif (post_retire_income >= 200000):
            effective_tax_rate = 34.08
        elif (post_retire_income >= 150000):
            effective_tax_rate = 32.23
        elif (post_retire_income >= 125000):
            effective_tax_rate = 31.55
        elif (post_retire_income >= 100000):
            effective_tax_rate = 29.20
        elif (post_retire_income >= 80000):
            effective_tax_rate = 26.63
        elif (post_retire_income >= 70000):
            effective_tax_rate = 24.87
        elif (post_retire_income >= 55000):
            effective_tax_rate = 21.16
        elif (post_retire_income >= 45000):
            effective_tax_rate = 18.93
        elif (post_retire_income >= 30000):
            effective_tax_rate = 15.99
        elif (post_retire_income >= 20000):
            effective_tax_rate = 12.78
        elif (post_retire_income >= 10000):
